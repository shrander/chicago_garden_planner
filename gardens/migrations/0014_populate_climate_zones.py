# Generated by Django 4.2.7 on 2025-11-18 04:38

from django.db import migrations


def populate_climate_zones(apps, schema_editor):
    """Populate ClimateZone table with all USDA hardiness zones"""
...
def reverse_populate_climate_zones(apps, schema_editor):
    """Remove all ClimateZone data"""
    ClimateZone = apps.get_model('gardens', 'ClimateZone')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gardens', '0013_rename_chicago_notes_to_growing_notes'),
    ]

    operations = [
        migrations.RunPython(populate_climate_zones, reverse_populate_climate_zones),
    ]
