"""
Production settings for Chicago Garden Planner
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'garden_planner'),
...
# Cache (optional - uncomment to use Redis)
# CACHES = {
#     'default': {
...
# Session (optional - use Redis for sessions)
